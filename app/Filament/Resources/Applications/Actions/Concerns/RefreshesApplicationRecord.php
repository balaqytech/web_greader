 ...
 * keeps rendering the pre-transition record — including a stale or still-absent
 * `activeContract` relation — after a successful mutation.
 */
trait RefreshesApplicationRecord
{
    protected function refreshLivewireRecord(Application $application, ?Component $livewire): void
    {
        $application->load('activeContract');
